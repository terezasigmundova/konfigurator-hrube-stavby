...
OUT = ROOT / "output" / "panel_1_1_vrstvy_a_vlastnosti.png"


def font(size: int, bold: bool = False) -> ImageFont.FreeTypeFont:
    name = "DejaVuSans-Bold.ttf" if bold else "DejaVuSans.ttf"
    return ImageFont.truetype(str(Path("/usr/share/fonts/truetype/dejavuja") / name), size=size)
...
def main() -> None:
    ...
    draw.text((56, 32), "PANEL 1.1  ·  VRSTVY A VLASTNOSTI", fill="#ffffff", font=font(44, True))
    ...
    draw.text((55, height - 40), "Zdroj: data/panel_1_1.json · rozměry v mm · společný zobrazovací standard PREFA_SOPIK_RENDER_STD_01", fill="#64736f", font=font(18))
